# =============================================================================
#  DL_utils.py  —  Model definitions, loss functions, and training utilities
#
#  Original author: Yuqiang (Ethan) Heng
#  Source repository: https://github.com/YuqiangHeng/DLGF
#
#  Modified by Sina Fazel:
#    - Added BF_loss (beamforming-only loss, no IA access penalty)
#    - Added eval_model helper for SNR evaluation
#    - Minor refactoring for multi-dataset training compatibility
# =============================================================================
"""
